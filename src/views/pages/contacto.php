<main class="min-h-max relative bg-cover bg-center flex flex-row" style="background-image: url('src/views/assets/svg/bg_contacto.svg')">
    <div class="w-full lg:w-[54%] xl:w-[50%] 2xl:w-[48%] flex flex-col justify-center items-center px-3 py-28">
        ...
        <div class="flex flex-col md:flex-row justify-center items-center  w-full mt-10 gap-12 md:gap-10 xl:gap-28 ">
            <div class="flex flex-col items-center gap-3 px-6 py-10 w-80 md:w-auto h-64 bg-[#E9A825] rounded-xl shadow-2xl shadow-yellow-900 border border-white hover:bg-black hover:text-white cursor-pointer hover:shadow-gray-950 transition-colors duration-500">
            ...
            <div class="flex flex-col items-center gap-3 px-8 py-10 w-80 md:w-auto h-64 bg-[#E9A825] rounded-xl shadow-2xl shadow-yellow-900 border border-white hover:bg-black hover:text-white cursor-pointer hover:shadow-gray-950 transition-colors duration-500">
                <i class="bi bi-geo-alt text-4xl text-white"></i>
                <p class="text-2xl font-extrabold">Ubicación</p>
                <p>Ubicanos en:</p>
                <a class="text-xs text-center font-bold">Av. Circunvalación Golf Los Incas, <br />Nro 208, Torre 3 oficina 602B <br />Santiago de Surco</a>
            </div>
        </div>

        <p class="font-medium mt-10 text-center">Bienvenido a nuestra página de contacto, el lugar donde nos encantaría escucharte. ¿Tienes preguntas o comentarios? Estamos asquí para ayudarte. Completa el formulario a continuación y nos pondremos en contacto contigo <br /> lo antes posible</p>
        ...
        <div class="flex flex-col gap-y-2 w-4/5 my-8">
            ...
            <select name="tipoPersona" id="tipoPersona" class="bg-black p-2 rounded-lg  cursor-pointer focus:outline-none text-white shadow-lg shadow-gray-700">
        ...
        <div id="form_persona_natural" class="hidden w-full mt-4">
            <form action="src/controller/enviar-correo-persona.php" id="form_contact_persona" method="post">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 w-full mt-6">
                    <div class="flex flex-col gap-y-2 w-full sm:w-5/12 relative text-white">
                        <label for="telefonoPersona" class="font-bold text-black">Teléfono fijo: (Opcional)</label>
                        <input type="text" placeholder="ej:332-7878" name="telefonoPersona" id="telefonoPersona"
                        ...
                        <p id="alert_phone_persona" class="hidden text-red-600 text-sm font-bold"></p>
                    </div>

                    <div class="flex flex-col gap-y-2 w-full sm:w-5/12 relative text-white">
                        <label for="celularPersona" class="font-bold text-black">Celular:</label>
                        <input type="text" name="celularPersona" id="celularPersona" placeholder="ej:922545301"
                        ...
                        <p id="alert_cel_persona" class="hidden text-red-600 text-sm font-bold"></p>
                    </div>
                </div>

                <div class="flex flex-col gap-3 w-full mt-6">
                    <label for="messagePersona" class="font-bold ms-0 sm:ms-16">Mensaje: </label>
                    <textarea name="messagePersona" rows="4" id="messagePersona" placeholder="Escribenos un mensaje.."
                ...
                <div class="w-4/5 mx-auto mt-11">
                    <button type="submit" id="button_persona" class="bg-[#E9A825] w-full py-3 rounded-lg border border-gray-800 hover:bg-yellow-700 hover:text-white text-lg transition-colors duration-500 font-bold shadow-lg shadow-yellow-800 flex items-center justify-center gap-x-2">
                        <div id="loading_persona" class="hidden border-t-transparent w-5 h-5 border-2 border-black rounded-full animate-spin"></div>
                        <span id="text_persona">Enviar</span>
                    </button>
                </div>
            </form>
        </div>
        ...
        <div id="form_persona_empresa" class="hidden w-full mt-4 px-2 sm:px-0">
            <form action="src/controller/enviar-correo-empresa.php" id="form_contact_empresa" method="post">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 w-full">
                    ...
                    <div class="flex flex-col gap-y-2 w-full sm:w-5/12">
                        ...
                        <select type="text" id="rubro" name="rubro" class="p-2 bg-black rounded-lg focus:outline-none cursor-pointer text-white font-medium shadow-lg shadow-gray-700" required>
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 w-full mt-6">
                    <div class="flex flex-col gap-y-2 w-full sm:w-5/12">
                        ...
                        <input type="text" name="ruc" id="ruc" placeholder="ej:20556778994" autocomplete="off"
                            class="px-4 py-2 bg-black rounded-lg focus:outline-none placeholder:text-gray-500 text-white shadow-lg shadow-gray-700"
                            pattern="[2][0-9]{10}"  maxlength="11" minlength="11" required />
                        <p id="alert_ruc" class="hidden text-red-600 text-sm font-bold"></p>
                    </div>
                    <div class="flex flex-col gap-y-2 w-full sm:w-5/12">
                        <label for="cargo" class="font-bold">Cargo:</label>
                        <input type="text" name="cargo" id="cargo" placeholder="Cargo que ejerce" class="px-4 py-2 bg-black rounded-lg focus:outline-none placeholder:text-gray-500 text-white shadow-lg shadow-gray-700" required />
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 w-full mt-6">
                    ...
                    <div class="flex flex-col gap-y-2 w-full sm:w-5/12">
                        ...
                        <select id="tipoServicio" name="tipoServicio" class="p-2 bg-black rounded-lg focus:outline-none cursor-pointer text-white font-medium shadow-lg shadow-gray-700" required>
                            ...
                            <option value="Mantenimiento e instalaciones">Mantenimiento de Edificios e Instalaciones</option>
                            ...
                            <option value="Construccion y manteimiento vial">Construcción y Mantenimiento Vial</option>
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 w-full mt-6">
                    <div class="flex flex-col gap-y-2 w-full sm:w-5/12 relative text-white">
                        <label for="telefonoEmpresa" class="font-bold text-black">Teléfono fijo: (Opcional)</label>
                        <input type="text" placeholder="ej:332-7878" name="telefonoEmpresa" id="telefonoEmpresa"
                            class="ps-[50px] py-2 bg-black rounded-lg focus:outline-none placeholder:text-gray-500 shadow-lg shadow-gray-700"
                            pattern="[2-7][0-9]{6}" minlength="7" maxlength="7"
                            oninvalid="setCustomValidity('Ingrese un número válido para Lima-Perú')"
                            oninput="setCustomValidity('')" autocomplete="off" />
                        <span class="absolute pe-1 left-[7px] top-10 border-r-2 border-white font-bold">(01)</span>
                        <p id="alert_phone_empresa" class="hidden text-red-600 text-sm font-bold"></p>
                    </div>

                    <div class="flex flex-col gap-y-2 w-full sm:w-5/12 relative text-white">
                        <label for="celularEmpresa" class="font-bold text-black">Celular:</label>
                        <input type="text" name="celularEmpresa" id="celularEmpresa" placeholder="ej:922545301"
                            class="ps-[62px] py-2 bg-black rounded-lg focus:outline-none placeholder:text-gray-500 shadow-lg shadow-gray-700"
                            autocomplete="off" pattern="[9][0-9]{8}"
                            oninvalid="setCustomValidity('Ingrese un numero valido, debe ser de nueve digitos y valido para Lima-Perú')"
                            oninput="setCustomValidity('')" maxlength="9" minlength="9" required />
                        <span class="absolute pe-1 left-[7px] top-10 border-r-2 border-white font-bold">(+51)</span>
                        <p id="alert_cel_empresa" class="hidden text-red-600 text-sm font-bold"></p>
                    </div>
                </div>

                <div class="flex flex-col gap-3 w-full mt-6">
                    <label for="mensajeEmpresa" class="font-bold ms-0 sm:ms-16">Mensaje: </label>
                    <textarea name="mensajeEmpresa" rows="4" id="mensajeEmpresa" placeholder="Escribenos un mensaje.."
                        class="rounded-lg bg-black text-white placeholder:text-gray-500 px-3 py-2 shadow-lg shadow-gray-700 w-full sm:w-[85%] mx-auto focus:outline-none"
                        required></textarea>
                </div>
                ...
                <div class="w-4/5 mx-auto mt-11">
                    <button type="submit" id="button_empresa" class="bg-[#E9A825] w-full py-3 rounded-lg border border-gray-800 hover:bg-yellow-700 hover:text-white text-lg transition-colors duration-500 font-bold shadow-lg shadow-yellow-800 flex items-center justify-center gap-x-2">
                        <div id="loading_empresa" class="hidden border-t-transparent w-5 h-5 border-2 border-black rounded-full animate-spin"></div>
                        <span id="text_empresa">Enviar</span>
                    </button>
                </div>
            </form>
        </div>
